...
### Mode 1: Backtest Only (Default)
**Command**: `docker-compose up -d`  
**Services**: `backend`, `frontend`  
**Purpose**: Verify backward compatibility - existing backtest system works as before

### Mode 2: Live Only
**Command**: `docker-compose --profile live up -d`  
**Services**: `backend`, `frontend`, `postgres`, `redis-live`, `live-backend`  
**Purpose**: Test live execution system with all required services

### Mode 3: Both (Backtest + Live)
**Command**: `docker-compose --profile both up -d`  
**Services**: Same as Mode 2 (backend + frontend + live services)  
**Purpose**: Test both systems running simultaneously
...
## Mode 3: Both (Backtest + Live) Testing
...
echo "=== Testing Mode 1: Backtest Only ==="
docker-compose down
docker-compose up -d
sleep 10
